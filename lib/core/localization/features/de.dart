...
const Map<String, String> _deStrings = {
    ...
    'homeFirstStepsBody': 'Vera wird deutlich besser, sobald dein erster Datenpunkt da ist. Importiere einen Auszug, scanne einen Beleg oder füge eine Bank hinzu, damit der Home-Bereich lebendig wird.',
    'homeFirstStepsHint': 'Schon einer dieser Schritte reicht, um Vorschläge, Kontostände und smarte Hinweise zu aktivieren.',
    'connectedAccountsEmptyTitle': 'Noch keine verbundenen Konten',
    'connectedAccountsEmptyBody': 'Sobald du eine Bank hinzufügst, verfolgen wir den Kontostand auf der Startseite und bereiten Uma-Aktionen mit besserem Kontext vor.',
    ...
    'umaInsightNoData': 'Vera kennt dich noch nicht. Importiere einen Auszug, scanne einen Beleg oder füge eine Bank hinzu, damit wir gemeinsam smarte Hinweise aufbauen können.',
    'umaInsightNoTransactions': 'Es sind noch keine Buchungen sichtbar. Importiere deinen ersten Auszug oder füge eine manuelle Buchung hinzu, damit Uma dein Ausgabemuster versteht.',
    'umaInsightNoPattern': 'Für diesen Zeitraum gibt es noch kein aussagekräftiges Ausgabenmuster. Mit neuen Buchungen wird der Einblick hier klarer.',
    'umaInsightTopCategory': 'Am meisten entfiel auf {category}: {amount}, also etwa {share}% des analysierten Gesamtbetrags von {total}.',
    ...
    'onbStep1Subtitle': 'Wähle zuerst deine Sprache. Du kannst sie jederzeit in den Einstellungen ändern.',
    'onbStep2Title': 'Mach es zu deinem',
    'onbStep2Subtitle': 'Wähle Palette und Stimmung der Marke. Das Theme kannst du später ändern.',
    'onbStep3Title': 'Bring deine Daten mit',
    'onbStep3Subtitle': 'Vera verbindet sich nicht mit deiner Bank — du bringst Auszüge mit, Vera versteht sie. Starte jetzt oder füge sie später hinzu.',
    'onbContinue': 'Weiter',
    ...
    'onbPalettePreviewBody': 'Deine Auswahl verändert Karten, KI-Highlights und die gesamte Stimmung sofort.',
    'onbBlankCanvasTitle': 'Auch leer zu starten ist okay',
    'onbBlankCanvasBody': 'Wenn du willst, kannst du jetzt ohne Import weitermachen; Vera begleitet dich auch beim ersten Schritt in der App.',
    'goalEmptyPrompt': 'Du hast noch kein Ziel festgelegt — tippe hier, um eines anzulegen.',
    'goalEmptyHint': 'Setze zuerst ein Ziel, dann kann Uma aus deinem Monatsrhythmus ableiten, wie viel du zurücklegen solltest.',
    ...
    'noTrackedBillsBody': 'Vera erinnert dich einen Tag vor dem Fälligkeitsdatum.',
    'billKindCard': 'Karte',
    ...
    'noTransactionsBody': 'Füge deine erste Buchung hinzu, importiere einen Auszug oder scanne einen Beleg.',
    'addHoldingTitle': 'Vermögenswert zum Portfolio hinzufügen',
    'addHoldingSubtitle': 'Wähle unten einen Bucket aus und gib den TL-Wert ein. Uma berechnet die Gewichte automatisch neu.',
    ...
    'noWealthActionsBody': 'Sobald du den autonomen Modus aktivierst, erscheinen Empfehlungen und Rebalancing-Schritte hier.',
    'startPortfolioTitle': 'Beginne mit deinem Portfolio',
    'startPortfolioBody': 'Füge Aktien, Gold, Bargeld oder Krypto hinzu. Uma beobachtet Abweichungen und schreibt hier Vorschläge.',
    ...
    'subscriptionsAttentionCount': '{n} Pläne brauchen in diesem Zyklus Aufmerksamkeit',
    'noSubscriptionsDetectedTitle': 'Noch keine Abos erkannt',
    'noSubscriptionsDetectedBody': 'Importiere einen Auszug oder scanne einen Beleg — Vera erkennt wiederkehrende Zahlungen automatisch.',
    ...
    'subsAlertSavingsMessageEmpty': 'Noch keine Abos erkannt. Importiere einen Auszug oder füge eines manuell hinzu, dann verfolgt Vera es.',
    'subsAlertSavingsMessageActive': 'Vera hat Abos gefunden, die du einfrieren oder auf ein kleineres Paket umstellen kannst, ohne deinen Alltag zu stören.',
    'subsAlertSavingsMetric': 'SPAREN',
    'subsAlertPriceTitle': 'Preiserhöhung erkannt',
    'subsAlertPriceMessageNone': 'In diesem Zyklus gibt es keine ungewöhnlichen Preissprünge.',
    'subsAlertPriceMessageSome': 'Ein oder mehrere Pläne sind im Vergleich zum letzten Monat teurer geworden.',
    ...
    'subsAlertUnusedMessageSome': '{n} Pläne wirken anhand deines letzten Aktivitätsmusters wenig genutzt.',
    'subsAlertUnusedMetric': 'LEER',
    'subsInsightEmpty': 'Vera analysiert deine Auszüge oder Belege und sammelt deine Abos hier.',
    'subsInsightHealthy': 'Deine Abos sehen diesen Monat gesund aus. Es gibt kein akutes Sparleck.',
    'subsInsightNeedsAttention': 'Du hast {n} Abos, die sich lohnen zu prüfen. Vera schätzt, dass du etwa {amount} pro Monat zurückholen könntest, indem du ungenutzte pausierst und teurere herabstufst.',
    ...
    'subsRecommendationDetected': 'Vera hat dieses Abo in einem importierten Auszug erkannt. Nutzt du es noch?',
    ...
    'proactiveBillBody': '{amount} · noch {days} Tage. Soll Uma den Zahlungsplan vorbereiten?',
    ...
    'proactiveUnusedBody': 'Zuletzt genutzt: {last}. Das könnte ein stilles Geldleck sein.',
    'proactiveUnusedCta': 'Abos öffnen',
    'proactiveHealthyTitle': 'Im Moment kein kritisches Signal',
    'proactiveHealthyBody': 'Aktuell sehen wir weder eine dringende Rechnung noch einen Preissprung oder ein offensichtlich unnötiges Abo. Wenn du willst, schaut Uma trotzdem kurz drauf.',
    'proactiveHealthyCta': 'Uma einschätzen lassen',
    'proactiveEmptyTitle': 'Vera hat noch kein Signal zum Beobachten gefunden',
    'proactiveEmptyBody': 'Sobald du einen Auszug importierst, hebt Vera anstehende Zahlungen, Abos und kleine Risiken hier hervor.',
    ...
    'signupErrorShortPassword': 'Das Passwort muss mindestens 6 Zeichen lang sein.',
    'signupErrorPasswordMismatch': 'Die Passwörter stimmen nicht überein.',
    'signupErrorAcceptTerms': 'Bitte akzeptiere die Bedingungen, um fortzufahren.',
