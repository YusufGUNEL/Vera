...
const Map<String, String> _enStrings = {
  ...
  'askUma': 'Ask Uma',
  'securityTitle': 'Security & insights',
  'securitySubtitle':
      'Vera does not block your bank — it turns your spending data into guidance.',
  'securityStatBlockedLabel': 'OPEN',
  'securityStatBlockedSub': 'insights',
  'securityStatReviewedLabel': 'REVIEWED',
  'securityStatReviewedSub': 'this week',
  'securityStatDevicesLabel': 'PATTERNS',
  'securityStatDevicesSub': 'watched',
  'securityAccountSection': 'SPENDING RADAR',
  'securityClearBody': 'No open spending insights — your data looks steady.',
  'securityActiveBody': 'Vera suggests reviewing {n} spending insights.',
  'securityViewReport': 'UMA EXPLANATION',
  'securityDecisionKept':
      'You asked to keep watching this insight. I will surface similar moves again.',
  'securityDecisionApproved':
      'You marked this as normal spending. I will show fewer similar insights.',
  'securityPillBlocked': 'HIGH PRIORITY',
  'securityPillKept': 'WATCHING',
  ...
  'umaForwardNote':
      'The action completes inside your bank app. Vera tracks the outcome via SMS or statement.',
  ...
  'statusAllClear': 'No insights',
  'statusMonitoring': '{n} insights',
  'securityRecentActivity': 'Spending insights',
  'securityScanning': 'Analyzing...',
  'liveAnomalyDetected': 'From your data',
  'highRiskConfidence': 'High priority',
  'reviewedSignal': 'Low priority',
  'keepBlocked': 'Keep watching',
  'thisWasMe': 'Normal spending',
  'emailField': 'Email',
  ...
  'dragDropOr': 'or use the buttons below',
  'umaGreeting':
  ...
  'securityEmptyTitle': 'No spending insights yet',
  'securityEmptyBody':
      'As you import statements or scan receipts, Vera will surface unusual amounts and repeat spending here as guidance.',
  'close': 'Close',
  ...
  'signupCtaContinueLocal': 'Continue locally',
