...
const Map<String, String> _enStrings = {
    ...
    'homeFirstStepsBody': 'Vera gets much better after your first piece of data arrives. Import a statement, scan a receipt, or add a bank to bring the home screen to life.',
    'homeFirstStepsHint': 'Even one of these is enough to unlock suggestions, balances, and smart alerts.',
    'connectedAccountsEmptyTitle': 'No connected accounts yet',
    'connectedAccountsEmptyBody': 'Once you add a bank, we can track its balance on home and prepare Uma actions with better context.',
    ...
    'umaInsightNoData': 'Vera does not know you yet. Import a statement, scan a receipt, or add a bank so we can start building smarter guidance together.',
    'umaInsightNoTransactions': 'No transactions are visible yet. Import your first statement or add a manual transaction so Uma can map your spending rhythm.',
    'umaInsightNoPattern': 'There is not enough meaningful spending pattern for this period yet. As new transactions arrive, the insight here will get sharper.',
    'umaInsightTopCategory': 'You spent the most on {category}: {amount}, about {share}% of the analyzed total of {total}.',
    ...
    'proactiveHealthyBody': 'There is no urgent bill, price spike, or obviously wasted subscription at the moment. Uma can still give this period a quick read if you want.',
    'proactiveHealthyCta': 'Ask Uma for a read',
    'proactiveEmptyTitle': 'Vera has not found a signal to watch yet',
    'proactiveEmptyBody': 'Once you import a statement, Vera surfaces upcoming payments, subscriptions, and small risks here.',
    ...
    'onbPalettePreviewBody': 'Your choice instantly changes cards, AI highlights, and the overall tone.',
    'onbBlankCanvasTitle': 'Starting empty is fine too',
    'onbBlankCanvasBody': 'If you want, continue without importing anything now; Vera will guide your first step inside as well.',
    ...
    'goalEmptyHint': 'Set a goal first, then let Uma estimate how much you should put aside each month.',
    ...
    'noTransactionsBody': 'Add your first transaction, import a statement, or scan a receipt.',
    'addHoldingTitle': 'Add holding to portfolio',
    'addHoldingSubtitle': 'Pick one of the buckets below and enter its TL value. Uma recalculates the weights automatically.',
    ...
    'noWealthActionsBody': 'Once you enable autonomous mode, recommendations and rebalance moves will show up here.',
    'startPortfolioTitle': 'Start building your portfolio',
    'startPortfolioBody': 'Add equities, gold, cash, or crypto holdings. Uma tracks drift and writes suggestions here.',
    ...
    'noSubscriptionsDetectedBody': 'Import a statement or scan a receipt — Vera will automatically detect recurring payments.',
    ...
    'subsAlertSavingsMessageEmpty': 'No subscriptions detected yet. Import a statement or add one manually and Vera will track it.',
    'subsAlertSavingsMessageActive': 'Vera found subscriptions you can freeze or downgrade without disrupting your routine.',
    ...
    'subsAlertPriceMessageSome': 'One or more plans increased in price compared with last month.',
    'subsAlertPriceMetric': 'UP',
    'subsAlertUnusedTitle': 'Lightly used plans',
    'subsAlertUnusedMessageNone': 'All subscriptions look healthy.',
    'subsAlertUnusedMessageSome': '{n} plans appear lightly used based on your recent activity pattern.',
    'subsAlertUnusedMetric': 'IDLE',
    'subsInsightEmpty': 'Vera analyzes your statements or receipts and groups your subscriptions here.',
    'subsInsightHealthy': 'Your subscriptions look healthy this month. No urgent savings leak is visible.',
    'subsInsightNeedsAttention': 'You have {n} subscriptions worth reviewing. Vera estimates you could recover about {amount} per month by freezing unused ones and downgrading the pricier ones.',
    ...
    'subsRecommendationDetected': 'Vera detected this subscription from an imported statement. Are you still using it?',
