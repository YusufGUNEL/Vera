...
const Map<String, String> _trStrings = {
    ...
    'homeFirstStepsBody': 'Vera en iyi ilk verin geldikten sonra şekillenir. Bir ekstre yükle, fiş tara ya da bir banka ekleyerek ana ekranı canlandır.',
    'homeFirstStepsHint': 'Bunlardan sadece biri bile önerileri, bakiyeyi ve akıllı uyarıları başlatır.',
    'connectedAccountsEmptyTitle': 'Henüz bağlı hesap görünmüyor',
    'connectedAccountsEmptyBody': 'Bir banka eklediğinde bakiyeni ana ekranda izler, Uma aksiyonlarını daha doğru bağlamla hazırlarız.',
    ...
    'umaInsightNoData': 'Vera seni henüz tanımıyor. Bir ekstre yükle, fiş tara veya banka ekle; birlikte akıllı önerileri başlatalım.',
    'umaInsightNoTransactions': 'Henüz işlem görünmüyor. İlk ekstreni yükle ya da manuel işlem ekle; Uma harcama düzenini çıkarsın.',
    'umaInsightNoPattern': 'Bu dönem için anlamlı bir harcama deseni henüz oluşmadı. Yeni işlemler geldikçe burada daha net içgörü göreceksin.',
    'umaInsightTopCategory': 'En çok {category} tarafında yoğunlaştın: {amount}, yani analiz edilen toplam {total} harcamanın %{share}’i.',
    ...
    'proactiveHealthyBody': 'Yaklaşan fatura, fiyat artışı veya boşa akan abonelik görünmüyor. İstersen Uma bu dönemi hızlıca yorumlasın.',
    'proactiveHealthyCta': 'Uma yorumlasın',
    'proactiveEmptyTitle': 'Vera henüz izlenecek sinyal bulmadı',
    'proactiveEmptyBody': 'Bir ekstre yüklediğinde Vera yaklaşan ödemeleri, abonelikleri ve küçük riskleri bu alanda öne çıkarır.',
    ...
    'onbPalettePreviewBody': 'Seçtiğin görünüm kartlar, AI vurguları ve genel tona anında yansır.',
    'onbBlankCanvasTitle': 'Boş başlamak da olur',
    'onbBlankCanvasBody': 'İstersen şimdi hiçbir şey import etmeden devam et; Vera seni içeride ilk adımda da yönlendirir.',
    ...
    'goalEmptyHint': 'Önce bir hedef koy, sonra Uma aylık ritmine göre ne kadar ayırman gerektiğini çıkarsın.',
    ...
    'noTransactionsBody': 'İlk işlemini ekle, ekstre yükle veya fiş fotoğrafı çek.',
    'addHoldingTitle': 'Portföye varlık ekle',
    'addHoldingSubtitle': 'Aşağıdaki bucket\'lardan birini seçip TL değerini gir. Uma ağırlıkları otomatik hesaplar.',
    ...
    'noWealthActionsBody': 'Otonom modu açtığında öneriler ve rebalans hareketleri burada görünür.',
    'startPortfolioTitle': 'Portföyünü oluşturmaya başla',
    'startPortfolioBody': 'Hisse, altın, nakit veya kripto varlıklarını ekle. Uma sapmayı izleyip önerilerini buraya yazar.',
    ...
    'noSubscriptionsDetectedBody': 'Ekstre yükle veya fiş tara — Vera tekrar eden ödemeleri otomatik tespit eder.',
    ...
    'subsAlertSavingsMessageEmpty': 'Henüz abonelik tespit edilmedi. Ekstre yükle veya manuel ekle, Vera takip etsin.',
    'subsAlertSavingsMessageActive': 'Vera, rutinini bozmadan dondurabileceğin veya alt pakete düşürebileceğin abonelikler buldu.',
    ...
    'subsAlertPriceMessageSome': 'Bir veya daha fazla planın fiyatı geçen aya göre arttı.',
    ...
    'subsAlertUnusedMessageSome': 'Son aktivite örüntüne göre {n} plan az kullanılıyor görünüyor.',
    'subsAlertUnusedMetric': 'BOŞTA',
    'subsInsightEmpty': 'Vera ekstreni veya fişlerini analiz edip aboneliklerini bu listede toplar.',
    'subsInsightHealthy': 'Abonelikler bu ay sağlıklı görünüyor. Acil bir tasarruf kaçağı yok.',
    'subsInsightNeedsAttention': 'Hızlıca incelemen gereken {n} abonelik var. Vera, kullanılmayanları dondurarak ve fiyat artışı olanları alt pakete düşürerek aylık {amount} kadar geri kazanabileceğini hesaplıyor.',
    ...
    'subsRecommendationDetected': 'Vera bu aboneliği import edilen ekstreden tespit etti. Hâlâ kullanıyor musun?',
